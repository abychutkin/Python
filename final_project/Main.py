...
# Инициализация pygame, создание главной поверхности, установка названия окна
pygame.init()
...
# Я так понимаю тут задается размер спрайта и создается игра
size = 60
...
while engine.working:
    ...
    # Немного странно получается, на основной поверхности прорисовывается
    # прорисовывается цепочка обязанностей
    gameDisplay.blit(drawer, (0, 0))
    # А потом цепочка обязанностей прорисовывает основную поверхность

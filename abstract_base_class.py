# Суть задания заключается в создании базового абстрактного класса для
# классов A, B, C, которые были предоставлены заранее. Базовый класс
# изначально не давался.
